...
namespace db103215_MIS4200v2.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "courseID,courseName,description,studentID")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "courseID,courseName,description,studentID")] Course course)
        {
            if (ModelState.IsValid)
            {
